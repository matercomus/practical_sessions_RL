...
class DataCenterEnv(gym.Env):
    def __init__(self, path_to_test_data):
        ...
        self.max_storage_capacity = # TODO 1: Set the maximum storage capacity
    ...
    def step(self, action):
        ...
        if energy_transacted > 0:
            # Buying
            buy_amount = # TODO 2: Calculate the amount of energy to buy
            cost = buy_amount * price
            self.storage_level += buy_amount
            reward = -cost
        else:
            # Selling
            sell_amount = # TODO 3: Calculate the amount of energy to sell
            revenue = sell_amount * # TODO 4: Calculate the revenue
        ...
        if self.hour == 25:
            ...
            carryover = # TODO 5: Calculate the carryover
