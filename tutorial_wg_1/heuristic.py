...
def heuristic_action(price, storage, hour, threshold=75):
    """
    Smarter heuristic:
    ...
    if excess_energy > 0 and price > threshold:
        return -1.0
        
    # If price is good and we still need energy, buy
    if price < threshold and storage < 120:
        return 1.0
...
def main():
    ...
    for episode in range(args.episodes):
        ...
        while not terminated:
            ...
            action = heuristic_action(price, storage, hour, args.threshold)
